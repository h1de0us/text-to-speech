...
def get_data_to_buffer(
    ...
    buffer = list()
    text_to_process = process_text(data_path)

    start = time.perf_counter()
    for i in tqdm(range(len(text_to_process))):
        ...
        buffer.append({"text": character, "duration": duration,
                       "mel_target": mel_gt_target, "batch_expand_size": batch_expand_size})
